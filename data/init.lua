...
Servers_init = {
    ...
    ["Derakus Legends 7.72"] = {
        ["host"] = "ot.derakusproductions.com",
        ["port"] = 7271,
        ["protocol"] = 772,
        ["httpLogin"] = false
    },
    ["Derakus Legends 8.60"] = {
        ["host"] = "ot.derakusproductions.com",
        ["port"] = 7371,
        ["protocol"] = 860,
        ["httpLogin"] = false
    },
    ["Derakus Legends 10.98"] = {
        ["host"] = "ot.derakusproductions.com",
        ["port"] = 7471,
        ["protocol"] = 1098,
        ["httpLogin"] = false
    },
    ["Derakus Legends 12.64"] = {
        ["host"] = "ot.derakusproductions.com",
        ["port"] = 7571,
        ["protocol"] = 1264,
        ["httpLogin"] = false
...
g_app.setCompactName("derakus");
g_app.setOrganizationName("derakusproductions");
